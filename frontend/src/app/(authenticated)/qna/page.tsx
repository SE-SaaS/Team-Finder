                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-2 flex items-center flex-wrap gap-x-3 gap-y-1 text-[11px] text-[#8b949e]">
                        <span>
                          by <span className="text-[#c9d1d9]">{q.author_name ?? 'anonymous'}</span>
                        </span>
                        <span>•</span>
                        ...
                        {q.tags.length > 0 && (
                          <>
                            ...
                            <span className="flex items-center gap-1.5 flex-wrap">
                              {q.tags.map((t) => (
                                <span key={t} className="px-1.5 py-0.5 rounded bg-[#1f6feb]/20 text-[#58a6ff]">
                                  {t}
                                </span>
                              ))}
                            </span>
                    ...
                    <div className="flex flex-col items-end gap-1 text-[11px] text-[#8b949e] shrink-0">
                      <span><span className="text-[#f0f6fc] font-semibold">{q.vote_count}</span> votes</span>
                      <span><span className="text-[#f0f6fc] font-semibold">{q.answer_count}</span> answers</span>
                    </div>
                  </div>
                </Link>
              </li>
