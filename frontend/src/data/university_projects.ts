// Standardized university projects - always available for testing/demo
// Similar to courses data structure
...
export interface UniversityProject {
  ...
  team_size: number
  deadline: string
  university: 'University of Jordan' | 'Hashemite University'
  status: 'open' | 'locked'
  tags?: string[]
}

// JU Projects
export const juProjects: UniversityProject[] = [
  {
    id: 'ju-proj-001',
    type: 'university',
...
// HU Projects
export const huProjects: UniversityProject[] = [
  {
    id: 'hu-proj-001',
    type: 'university',
...
// Combined list
export const universityProjects = [...juProjects, ...huProjects]
