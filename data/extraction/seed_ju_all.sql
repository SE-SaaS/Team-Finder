-- Complete seed data for JU majors
...
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cis-1901341', '1901341', 'Theory of Algorithms', 'JU', 'CIS', 2, 1, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cis-1901359', '1901359', 'Computer Graphics', 'JU', 'CIS', 2, 2, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cis-1902242', '1902242', 'Artificial Intelligence', 'JU', 'CIS', 3, 1, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cis-1901354', '1901354', 'Computer Networks', 'JU', 'CIS', 3, 1, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cis-1901473', '1901473', 'Operating Systems', 'JU', 'CIS', 3, 2, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cis-1905322', '1905322', 'Data Mining', 'JU', 'CIS', 3, 2, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cis-1902310', '1902310', 'Advanced AI Programming', 'JU', 'CIS', 4, 1, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cis-1904340', '1904340', 'Natural Language Processing', 'JU', 'CIS', 4, 1, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cis-1915380', '1915380', 'Machine Learning and Neural Networks', 'JU', 'CIS', 4, 1, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cis-1902231', '1902231', 'Web Server Programming', 'JU', 'CIS', 4, 2, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cis-1911351', '1911351', 'Security of Web Applications', 'JU', 'CIS', 4, 2, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
...
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cys-1911251v2', '1911251', 'Security Risk Assessment and Ethics', 'JU', 'CYS', 2, 1, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
...
INSERT INTO public.courses (id, code, name, university, major, year, semester, credit_hours, prerequisite_ids, unlocks_skills, description)
VALUES ('ju-cys-0101131', '0101131', 'Principles of Statistics', 'JU', 'CYS', 2, 2, 3, ARRAY[]::TEXT[], ARRAY[]::INTEGER[], NULL);
